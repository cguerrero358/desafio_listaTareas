const IngresoTareaInput= document.querySelector("input");
...
btn.addEventListener("click", ()=> {
    const { value:IngresoTarea}= IngresoTareaInput;
    if (IngresoTarea) {
        addTask (IngresoTarea);
        refresh();
    }
    else alert ("Ingrese una Tarea");
});

const addTask=(IngresoTarea) => {
